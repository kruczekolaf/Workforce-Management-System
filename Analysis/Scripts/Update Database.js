function update_database() {
  ...
  const areas_sheet = SpreadsheetApp.openById("1qvOVi5Jk86jJyvtUq4Nh0UBAo0ToaC-Zr-qk780atnw").getSheetByName("Areas");
  ...
  const analysis_sheet = SpreadsheetApp.openById("15zWq6frkb-ghUprdpDoKsAjmvpCkRv3rQKngO4jPrH4").getSheetByName("Database");
